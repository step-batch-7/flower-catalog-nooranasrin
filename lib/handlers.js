...
const { loadPreviousComments, isFileNotAvailable } = require('./loadFile');
...
const totalComments = CommentLog.load(loadPreviousComments());
...
const saveCommentsAndRedirect = function(request, response) {
  ...
  fs.writeFileSync(dataStoragePath, totalComments.toJSON());
